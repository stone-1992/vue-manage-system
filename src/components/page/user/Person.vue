    ...
    <div>
        ...
        <div class="container">
            <div class="handle-box">
                ...
                <el-button type="primary" @click="importHander" style="margin-right:200px">导入员工</el-button>
                <el-button type="primary" @click="template">下载模板</el-button>
            </div>
            <el-table
                :data="tableData"
                border
...
<script>
import {deleteRequest,getRequest,putRequest,postRequest,getFileRequest} from '../../../api/index';
    ...
    methods: {
        ...
        handleDelete(index, row) {
            ...
            this.$confirm('确定要删除吗？', '提示', {
                ...
                .then(() => {
                    deleteRequest('user-center/person/deletePerson', row).then(res => {
                        if(res.result){
        ...
        delAllSelection() {
            ...
            let query = {ids:str};
            deleteRequest('user-center/person/deletePersonBath', query).then(res => {
                if(res.result){
